...
def worm(acc, pas):
    ...
    for i in range(len(GenMustList)):
        ...
        if (GenMustListtmep[4].text == "通過" or int(GenMustListtmep[4].text) >= 60 or GenMustListtmep[4].text == "抵免"):
    ...
    for i in range(len(CollegeMustListView)):
        ...
        if (CollegeMustListViewtmep[4].text == "通過" or int(CollegeMustListViewtmep[4].text) >= 60 or CollegeMustListViewtmep[4].text == "抵免"):
    ...
    for i in range(len(CollegeProListView)):
        ...
        if (CollegeProListViewtmep[4].text == "通過" or int(CollegeProListViewtmep[4].text) >= 60 or CollegeProListViewtmep[4].text == "抵免"):
    ...
    for i in range(len(NoCollegeProListView)):
        ...
        if (NoCollegeProListViewtmep[4].text == "通過" or int(NoCollegeProListViewtmep[4].text) >= 60 or NoCollegeProListViewtmep[4].text == "抵免"):
    ...
    for i in range(len(GenSelectListView)):
        ...
        if (GenSelectListViewtmep[4].text == "通過" or int(GenSelectListViewtmep[4].text) >= 60 or GenSelectListViewtmep[4].text == "抵免"):
